...
import { Segment, Message, Form, Button, Dropdown, Divider, Icon } from 'semantic-ui-react'
    ...
    return (
        <div style={{width: '50%', margin: '0 auto'}}>
            ...
            <Segment attached='bottom' style={{padding: '2rem 5rem'}}>
                <Button fluid color='red' onClick={() => {window.open(`http://localhost:5000/auth/google`, "_self")}}>
                    <Icon name='google' />
                    Sign up with Google
                </Button>
