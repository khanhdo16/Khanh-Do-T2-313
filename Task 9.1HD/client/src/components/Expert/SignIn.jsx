...
import { Segment, Message, Form, Checkbox, Button, Icon } from 'semantic-ui-react'
            ...
            <Segment attached='bottom' style={{padding: '2rem 5rem'}}>
                <Form>
                    ...
                    <Button.Group fluid>
                        ...
                        <Button as='a' href='/expert/signup'>Sign up</Button>
                    </Button.Group>
                </Form>
            </Segment>
            <Segment>
                <Button href='/signin' fluid icon labelPosition='right'>
                    Sign in as Customer?
